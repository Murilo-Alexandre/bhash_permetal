...
const REMEMBER_LOGIN_KEY = "bhash_admin_remember_login";
const SAVED_CREDENTIALS_KEY = "bhash_admin_saved_credentials";
const MANUAL_LOGOFF_KEY = "bhash_admin_manual_logoff";
...
export function AdminAuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const [rememberLogin, setRememberLoginState] = useState<boolean>(
    () => localStorage.getItem(REMEMBER_LOGIN_KEY) === "1"
  );
